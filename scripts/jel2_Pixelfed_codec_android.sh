...
echo "hello from android script" >> /data/data/com.twosix.race/race/artifacts/ta2/PluginTA2SRIPixelfed/tmp2.log


#if [ "$SHELL" = "/system/bin/sh" ] ; then
#    # Android
TMP="/data/data/com.twosix.race/race/artifacts/ta2/PluginTA2SRIPixelfed/TMP"
mkdir -p $TMP
#else
#    # Not Android
#    TMP="/tmp"
...
echo "hello 1.1 from android script" >> /data/data/com.twosix.race/race/artifacts/ta2/PluginTA2SRIPixelfed/tmp2.log
...
if [ -z "$_wedge" ]; then
    apkpath=`pm path com.twosix.race|sed -e 's/base\.apk/lib\/x86_64/'|cut -d":" -f2`
    _wedge=$apkpath/libwedge.so
    _unwedge=$apkpath/libunwedge.so
fi

echo "hello2 from android" >> /data/data/com.twosix.race/race/artifacts/ta2/PluginTA2SRIPixelfed/tmp2.log

echo "$_wedge" >> /data/data/com.twosix.race/race/artifacts/ta2/PluginTA2SRIPixelfed/tmp2.log
echo "$_unwedge" >> /data/data/com.twosix.race/race/artifacts/ta2/PluginTA2SRIPixelfed/tmp2.log
...
case "$_cmd" in
    ...
    encode)
        _logEnc "$0 $*"
	cat > "$TMP/$$_msgIn"
	echo "hello encode from android" >> /data/data/com.twosix.race/race/artifacts/ta2/PluginTA2SRIPixelfed/tmp2.log
	ls -l "$TMP/$$_msgIn" >> /data/data/com.twosix.race/race/artifacts/ta2/PluginTA2SRIPixelfed/tmp2.log
	echo "$_wedge -data $TMP/$$_msgIn $* $TMP/$$_steg.jpg" >> /data/data/com.twosix.race/race/artifacts/ta2/PluginTA2SRIPixelfed/tmp2.log 

        "$_wedge" -data "$TMP/$$_msgIn" $*  "$TMP/$$_steg.jpg" >> /data/data/com.twosix.race/race/artifacts/ta2/PluginTA2SRIPixelfed/tmp2.log 2>&1
	_status=$?
	echo "wedge $_status" >> /data/data/com.twosix.race/race/artifacts/ta2/PluginTA2SRIPixelfed/tmp2.log
...
#	fi
        ...
        "$_unwedge" $* "$_jDeIn" "$_jDeOut" >> /data/data/com.twosix.race/race/artifacts/ta2/PluginTA2SRIPixelfed/tmp3.log  2>&1
	_status=$?
