...
public:
    ...
    /**
     * @brief Should be set to true if the channel supports being flushed by NetworkManager,
     * otherwise false.
     *
     */
    bool isFlushable;
 ...
 * each other. Properties are defined as static or dynamic in this document:
 * https://wiki.race.twosixlabs.com/pages/viewpage.action?spaceKey=RACE26&title=Static+ChannelProperties+Enforcement
...
void from_json(const nlohmann::json &j, ChannelProperties &channelProps);
