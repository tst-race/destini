...
public:
    ...
    /**
     * @brief Notify NetworkManager via the SDK that the status of this package has changed.
     *
    ...
    /**
     * @brief Notify NetworkManager via the SDK that the stauts of a connection has changed
     *
     * @param handle The RaceHandle identifying the NetworkManager call it corresponds to
    ...
    /**
     * @brief Notify NetworkManager via the SDK that the stauts of a channel has changed
     *
     * @param handle The RaceHandle identifying the NetworkManager call it corresponds to (if any)
    ...
    /**
     * @brief Notify NetworkManager via the SDK that the stauts of a link has changed
     *
     * @param handle The RaceHandle identifying the NetworkManager call it corresponds to (if any)
    ...
    /**
     * @brief Notify the SDK and NetworkManager of a change in LinkProperties
     *
    ...
    /**
     * @brief Notify NetworkManager via the SDK of a new EncPkg that was received
     *
