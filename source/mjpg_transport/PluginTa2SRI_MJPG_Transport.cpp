#include "PluginTa2SRI_MJPG_Transport.h"
...
PluginTa2SRI_MJPG_Transport::PluginTa2SRI_MJPG_Transport(ITransportSdk *sdk) :
    sdk(sdk),
...
ComponentStatus PluginTa2SRI_MJPG_Transport::onUserInputReceived(RaceHandle handle, bool answered,
...
TransportProperties PluginTa2SRI_MJPG_Transport::getTransportProperties() {
    TRACE_METHOD();
    return {
        // supportedActions
        {
...
LinkProperties PluginTa2SRI_MJPG_Transport::getLinkProperties(const LinkID &linkId) {
    TRACE_METHOD(linkId);
    return links.get(linkId)->getProperties();
}

bool PluginTa2SRI_MJPG_Transport::preLinkCreate(const std::string &logPrefix, RaceHandle handle,
                                                 const LinkID &linkId,
...
ComponentStatus PluginTa2SRI_MJPG_Transport::postLinkCreate(const std::string &logPrefix,
                                                             RaceHandle handle,
                                                             const LinkID &linkId,
...
std::shared_ptr<Link> PluginTa2SRI_MJPG_Transport::createLinkInstance(
  ...
  link->start();
  logDebug("in PluginTa2SRI_MJPG_Transport::createLinkInstance after link->start()");
  return link;
}


ComponentStatus PluginTa2SRI_MJPG_Transport::createLink(RaceHandle handle, const LinkID &linkId) {
    TRACE_METHOD(handle, linkId);
    logDebug(logPrefix + "in PluginTa2SRI_MJPG_Transport::createLink");
    ...
    logDebug(logPrefix + "PluginTa2SRI_MJPG_Transport::createLink hashtag:" + address.hashtag);
...
ComponentStatus PluginTa2SRI_MJPG_Transport::loadLinkAddress(RaceHandle handle,
                                                              const LinkID &linkId,
                                                              const std::string &linkAddress) {
    TRACE_METHOD(handle, linkId, linkAddress);
    logDebug(logPrefix + "PluginTa2SRI_MJPG_Transport::loadLinkAddress link address:" + linkAddress);
...
ComponentStatus PluginTa2SRI_MJPG_Transport::loadLinkAddresses(
...
// client pair.
//
ComponentStatus PluginTa2SRI_MJPG_Transport::createLinkFromAddress(
    ...
    logDebug("PluginTa2SRI_MJPG_Transport::createLinkFromAddress calling createLinkInstance:");
    LinkAddress address = nlohmann::json::parse(linkAddress);
    LinkProperties properties = defaultLinkProperties;
    auto link = createLinkInstance(linkId, address, properties);
...
ComponentStatus PluginTa2SRI_MJPG_Transport::destroyLink(RaceHandle handle, const LinkID &linkId) {
    TRACE_METHOD(handle, linkId);
...
std::vector<EncodingParameters> PluginTa2SRI_MJPG_Transport::getActionParams(
    const Action &action) {
...
ComponentStatus PluginTa2SRI_MJPG_Transport::enqueueContent(
...
ComponentStatus PluginTa2SRI_MJPG_Transport::dequeueContent(const Action &action) {
...
ComponentStatus PluginTa2SRI_MJPG_Transport::doAction(const std::vector<RaceHandle> &handles,
                                                       const Action &action) {
...
ITransportComponent *createTransport(const std::string &transport, ITransportSdk *sdk,
    ...
    return new PluginTa2SRI_MJPG_Transport(sdk);
}
