#ifndef __SOURCE_ENCODING_PLUGINSRIJELENCODING_H__
#define __SOURCE_ENCODING_PLUGINSRIJELENCODING_H__
...
class PluginTA2SRI_JELEncoding : public IEncodingComponent {
public:
    explicit PluginTA2SRI_JELEncoding(IEncodingSdk *sdk, const PluginConfig &pluginConfig);
