#ifndef __TA2_SRIFLICKR_TRANSPORT_H__
#define __TA2_SRIFLICKR_TRANSPORT_H__
...
class PluginTa2SRIFlickrTransport : public ITransportComponent {
public:
    explicit PluginTa2SRIFlickrTransport(ITransportSdk *sdk);
...
#endif  // __TA2_SRIFLICKR_TRANSPORT_H__
