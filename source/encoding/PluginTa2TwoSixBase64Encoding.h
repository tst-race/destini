#ifndef __SOURCE_ENCODING_PLUGINTA2TWOSIXBASE64ENCODING_H__
#define __SOURCE_ENCODING_PLUGINTA2TWOSIXBASE64ENCODING_H__

#include <IEncodingComponent.h>

#include <string>

class PluginTa2TwoSixBase64Encoding : public IEncodingComponent {
public:
    explicit PluginTa2TwoSixBase64Encoding(IEncodingSdk *sdk);
