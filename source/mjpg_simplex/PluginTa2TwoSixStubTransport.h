#ifndef __TA2_TWOSIX_TRANSPORT_H__
#define __TA2_TWOSIX_TRANSPORT_H__
...
class PluginTa2TwoSixStubTransport : public ITransportComponent {
public:
    explicit PluginTa2TwoSixStubTransport(ITransportSdk *sdk);
...
#endif  // __TA2_TWOSIX_TRANSPORT_H__