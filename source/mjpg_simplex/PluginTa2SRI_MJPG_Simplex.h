#ifndef __TA2_SRI_MJPG_SIMPLEX_H__
#define __TA2_SRI_MJPG_SIMPLEX_H__
...
class PluginTa2SRI_MJPG_Simplex : public ITransportComponent {
public:
    explicit PluginTa2SRI_MJPG_Simplex(ITransportSdk *sdk);
...
#endif  // __TA2_SRI_MJPG_SIMPLEX_H__
