...
class UserModelToTest : public PluginTa2TwoSixStubUserModel {
public:
    ...
    UserModelToTest(
        IUserModelSdk *sdk,
        std::unordered_map<LinkID, std::shared_ptr<MockLinkUserModel>> &mockLinkUserModels) :
        PluginTa2TwoSixStubUserModel(sdk), mockLinkUserModels(mockLinkUserModels) {}
...
class TestPluginTa2TwoSixUserModel : public ::testing::Test {
public:
...
TEST_F(TestPluginTa2TwoSixUserModel,
...
TEST_F(TestPluginTa2TwoSixUserModel, should_generate_empty_timeline_when_no_links) {
    timeline = userModel.getTimeline(1000.0, 1004.0);
    ASSERT_EQ(0, timeline.size());
}

TEST_F(TestPluginTa2TwoSixUserModel, should_generate_timeline_with_only_one_link) {
    userModel.addLink("LinkID_1", {});
...
TEST_F(TestPluginTa2TwoSixUserModel, should_generate_timeline_with_multiple_links) {
    userModel.addLink("LinkID_1", {});
...
TEST_F(TestPluginTa2TwoSixUserModel, should_not_include_removed_link_in_generated_timeline) {
    userModel.addLink("LinkID_1", {});
    EXPECT_CALL(*mockLinkUserModels["LinkID_1"], getTimeline(900.0, 1100.0))
        .WillOnce(::testing::Return(ActionTimeline({
            createAction(1001.0, 1, "LinkID_1", ACTION_FETCH),
...
TEST_F(TestPluginTa2TwoSixUserModel, should_offset_added_link_into_regenerated_timeline) {
    userModel.addLink("LinkID_1", {});
